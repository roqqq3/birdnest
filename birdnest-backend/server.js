...
import { getClosestViolations, updateRecentlyViolatingDrones } from "./getViolatingDrones.js"
...
app.get('/stream', (req, res) => {
    ...
    sse.send(getClosestViolations()) // Send currently stored violations to the client that just joined
});
...
const reportDrones = async () => {
    await updateRecentlyViolatingDrones()
    const violationsToSend = getClosestViolations()
